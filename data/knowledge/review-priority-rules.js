window.SBON_KNOWLEDGE_REVIEW_PRIORITY_RULES = [
  {
    ...
    severity: "high",
    findingJa:
      "古いOpenSSL系列が使われている可能性があります。サポート状況と更新計画を確認してください。",
    enabled: true,
  },
  {
    ...
    severity: "high",
    findingJa:
      "古いBusyBox系列が使われている可能性があります。製品内での利用範囲と更新可能性を確認してください。",
    enabled: true,
  },
  {
    ...
    severity: "high",
    findingJa:
      "古いLinux kernel系列が使われている可能性があります。長期保守版かどうかと更新方針を確認してください。",
    enabled: true,
  },
];
